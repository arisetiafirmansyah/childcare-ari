  ...
  <a href="<?= base_url('/home/tambah_orangtua') ?>"><button class="btn btn-success"><i class="fa fa-plus"></i></button></a>
  <tr>
    <th>NO</th>
    <th>Username</th>
    <th>JK</th>
      ...
      foreach ($okta as $evan) {
        ...
        <tr>
          ...
          <td><?php echo $evan->alamat?> </td>
           ...
           <td> 
            <a href="<?=base_url('/home/edit_orangtua/'.$evan->user)?>"> <button class="btn btn-primary"><i class="fa fa-edit"></i></button></a>

            <a href="<?=base_url('/home/hapus_orangtua/'.$evan->user)?>"> <button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
